...
# Create a new data by filtering the outlier and adjust the ggplot code to draw the plot again with the new data
...
RATS_reg <- RATSL %>% lm(Weight ~ Time + Group, data = .)
